...
window.WF_GRAPH=(function(){
  ...
  nodes.push({id:'wf:hub',label:'워크플로우 보드',group:'wf',color:WFC,url:'https://seum8660.github.io/workflow/%ED%95%99%EA%B5%90%EC%8B%9C%EC%84%A4%20%EC%9B%8C%ED%81%AC%ED%94%8C%EB%A1%9C%EC%9A%B0%20%EC%9D%B8%ED%8A%B8%EB%A1%9C.dc.html'});
  links.push({source:'root',target:'wf:hub',kind:'wf'});
  Object.keys(WF_TAGS).forEach(function(k){
    var bid='wf:'+k;
    nodes.push({id:bid,label:WF_BOARDNM[k]||k,group:'wf',color:WFC,url:'https://seum8660.github.io/workflow/%ED%95%99%EA%B5%90%EC%8B%9C%EC%84%A4%20%EC%9B%8C%ED%81%AC%ED%94%8C%EB%A1%9C%EC%9A%B0%20%EC%9D%B8%ED%8A%B8%EB%A1%9C.dc.html',board:k});
